...
select pg_advisory_xact_lock(
  hashtext('atehna:database-schema-contract:20260905.analytics-v4')
);
...
begin
  if exists (
    select 1
     ...
     where contract_id = '20260905.analytics-v4'
       and contract_sha256 <>
          'a2d78beb3aa65a1b60a75e11b6efed10a78e6f00cabb9af8a4ebacc592eaa4da'
  ) then
    raise exception
      'Schema contract 20260905.analytics-v4 already exists with another checksum';
  end if;
end;
$contract_identity$;
