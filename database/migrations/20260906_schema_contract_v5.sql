...
select pg_advisory_xact_lock(
  hashtext('atehna:database-schema-contract:20260906.pricing-stock-v5')
);
...
begin
  if exists (
    select 1
     ...
     where contract_id = '20260906.pricing-stock-v5'
       and contract_sha256 <>
          '734e6783336185c47794343094842fa51474ee0f384b8a702f64220ac08528bd'
  ) then
    raise exception
      'Schema contract 20260906.pricing-stock-v5 already exists with another checksum';
  end if;
end;
$contract_identity$;
