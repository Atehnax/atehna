      ...
      <Table className="w-full min-w-[1080px] table-fixed border-collapse text-[11px] font-['Inter',system-ui,sans-serif]">
          ...
          <THead>
            <TR>
              ...
              {visibleColumns.orderDate ? <TH className="text-[11px]">
                <div className="relative inline-flex items-center gap-1.5 align-middle" data-archive-header-filter="true">
                  ...
                  {openHeaderFilter === 'orderDate' ? (
                    <div role="menu" className="absolute left-1/2 top-8 z-30 w-52 -translate-x-1/2 rounded-xl border border-slate-200 bg-white p-2 text-left shadow-lg">
              ...
              {visibleColumns.orderType ? <TH className="text-[11px]">
                <div className="relative inline-flex items-center gap-1.5 align-middle" data-archive-header-filter="true">
            ...
            {pagedRows.map((row) => {
              ...
              return (
                <TR key={entry.id} className={`border-b border-slate-100 bg-white transition-colors ${adminTableRowToneClasses.hover}`}>
                  ...
                  {visibleColumns.type ? <TD className="px-0 py-2 text-[11px] font-semibold text-slate-700">
                    <span
                  ...
                  {visibleColumns.orderDate ? <TD className="px-0 py-2 text-xs text-slate-500">
                    <span
                  ...
                  {visibleColumns.customer ? <TD className="px-0 py-2 text-xs text-slate-600">
                  ...
                  {visibleColumns.address ? <TD className="px-0 py-2 text-xs text-slate-600">
                  ...
                  {visibleColumns.orderType ? <TD className="px-0 py-2 text-xs text-slate-600">
                  ...
                  {visibleColumns.deleted ? <TD className="px-0 py-2 text-xs text-slate-500">
                  ...
                  {visibleColumns.expires ? <TD className="px-0 py-2 text-xs text-slate-500">
