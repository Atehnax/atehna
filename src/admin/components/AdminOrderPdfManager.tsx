    ...
    <section className="w-full min-w-0 max-w-full overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm font-['Inter',system-ui,sans-serif]">
      ...
      <div className="mt-3 p-0">
        <textarea
          ...
          className={`${notesSharedClass} ${adminInputFocusTokenClasses} transition ${notesSectionMode === 'edit' ? 'bg-white text-slate-900' : '!bg-[color:var(--field-locked-bg)] text-slate-600'}`}
        />
      </div>
