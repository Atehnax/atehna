...
function SidebarIcon({ type }: { type: SidebarIconType }) {
  ...
  if (type === 'products') return <svg viewBox="0 0 20 20" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2.8 17 6.2 10 9.6 3 6.2 10 2.8Z"/><path d="M3.8 7.5v7.2L10 18V10.3"/><path d="M16.2 7.5v7.2L10 18"/></svg>;
