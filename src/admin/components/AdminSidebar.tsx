...
function SidebarIcon({ type }: { type: SidebarIconType }) {
  ...
  if (type === 'products') return <svg viewBox="0 0 20 20" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="1.7"><rect x="4" y="4" width="12" height="12" rx="2.2"/><path d="M7 9.5h6"/><path d="M7 12.5h6"/></svg>;
