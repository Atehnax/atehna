import AdminAnalyticsDashboard from '@/admin/features/analitika/components/AdminAnalyticsDashboard';
import type { AdminOrdersHeatmapDay } from '@/admin/features/analitika/components/AdminOrdersActivityHeatmap';
