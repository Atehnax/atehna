                    ...
                    {isTableEditable ? (
                      <div className={`inline-flex h-5 items-center justify-center whitespace-nowrap ${isToleranceLocked ? 'text-slate-500' : ''}`}>
                        ...
                        <input
                          ...
                          maxLength={1}
                          className={`${compactTableAlignedInputClassName} !mt-0 !w-[2ch] !px-0 text-center ${isToleranceLocked ? '!bg-[color:var(--ui-neutral-bg)] text-slate-500' : ''}`}
