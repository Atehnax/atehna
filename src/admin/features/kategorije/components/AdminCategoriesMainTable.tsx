...
export const InlineStatusToggle = ({
  ...
  <button
    ...
    className="relative inline-flex h-7 w-[68px] items-center rounded-full border-2 border-[#3b4754] bg-[#f2f2f1] transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3e67d6]/50 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
  >
    <span aria-hidden="true" className={`pointer-events-none absolute top-1/2 -translate-y-1/2 transition-all duration-200 ${checked ? 'left-2 text-[#1fa56a]' : 'right-2 text-[#df4f67]'}`}>
      {checked ? (
    ...
    >
      <span
        className={`absolute left-1/2 top-1/2 h-1.5 w-1.5 -translate-x-1/2 -translate-y-1/2 rounded-full ${
          checked
            ? 'bg-[#51ee87] shadow-[0_0_8px_rgba(81,238,135,0.82)]'
            : 'bg-[#77808b]'
        }`}
      />
    </span>
