...
export const InlineStatusToggle = ({
  ...
  <button
    ...
    className="relative inline-flex h-8 w-[76px] items-center rounded-full border-[3px] border-[#3b4754] bg-[#f2f2f1] px-1.5 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3e67d6]/50 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
  >
    <span aria-hidden="true" className={`pointer-events-none absolute top-1/2 -translate-y-1/2 transition-all duration-200 ${checked ? 'left-2.5 text-[#1fa56a]' : 'right-2.5 text-[#df4f67]'}`}>
      {checked ? (
    ...
    <span
      aria-hidden="true"
      className={`absolute left-0.5 top-0.5 z-10 h-6 w-6 rounded-full border border-[#37424f] bg-[#4f5b68] shadow-[inset_0_1px_2px_rgba(255,255,255,0.08),inset_0_-3px_6px_rgba(0,0,0,0.22),0_6px_14px_rgba(20,30,45,0.35)] transition-transform duration-200 ${
    ...
    >
      <span
        className={`absolute left-1/2 top-1/2 h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full ${
          checked
            ? 'bg-[#51ee87] shadow-[0_0_10px_rgba(81,238,135,0.85)]'
            : 'bg-[#77808b]'
        }`}
      />
    </span>
