...
const projectSummary = ({ summary }: BusinessAnalyticsResponse): BusinessOrderPreviewSummary => ({
  orderCount: summary.orderCount,
  activityValue: summary.activityValue,
  realisedValue: summary.realisedValue,
  realisedCount: summary.realisedCount,
  meanOrderValue: summary.meanOrderValue,
  ...
  return (
    <section aria-label="Analitika naročil" aria-busy={loading} className="mb-3">
      <div className="mb-3 flex flex-wrap items-end justify-end gap-2">
        ...
        <AdminPeriodSelector value={range} onChange={setRange} ariaLabel="Obdobje analitike naročil" />
      </div>
