  ...
  return (
    <div className="container-base site-section">
      <div className="w-full">
        <h1 className="site-heading-1">{page.title}</h1>
        <div className="mt-4">
        ...
        {categories.map((category) => {
          ...
          return (
            <Link
              ...
              prefetch={false}
              className="site-panel group overflow-hidden transition hover:-translate-y-1 hover:border-brand-200"
            >
              ...
              <div className="p-5">
                <h3 className="site-heading-3">{category.title}</h3>
