  ...
  return (
    <div className={`flex flex-col items-end gap-1 ${className ?? ''}`.trim()}>
      <button
        ...
        className="inline-flex h-8 items-center gap-1.5 rounded-xl border border-[#d6ccfb] bg-[#f8f7fc] px-3 text-xs font-semibold text-[#5a3fda] shadow-sm transition hover:bg-[#f1eefc] focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-[#8269e1] disabled:cursor-not-allowed disabled:border-slate-200 disabled:bg-slate-200 disabled:text-slate-400"
      >
