  ...
  return (
    <div className={`flex flex-col items-end gap-1 ${className ?? ''}`.trim()}>
      <button
        ...
        className="inline-flex h-8 items-center gap-1.5 rounded-xl border border-brand-600 bg-brand-600 px-3 text-xs font-semibold text-white shadow-sm transition hover:bg-brand-700 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-300 disabled:cursor-not-allowed disabled:border-slate-200 disabled:bg-slate-200 disabled:text-slate-400"
      >
