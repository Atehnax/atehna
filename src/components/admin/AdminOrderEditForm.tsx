  ...
  return (
    <div className="group relative" data-filled={isFilled(value) ? 'true' : 'false'}>
      <input
        ...
        className="h-11 w-full rounded-xl border border-slate-300 bg-white px-3 pb-1 pt-4 text-[12px] text-slate-900 shadow-sm outline-none transition focus:border-[#ede8fe] focus:ring-1 focus:ring-[#ede8fe]"
      />
      <label
        htmlFor={id}
  ...
  return (
    <div className="group relative" data-filled={isFilled(value) ? 'true' : 'false'}>
      <textarea
        ...
        placeholder=" "
        onChange={(event) => onChange(event.target.value)}
        className="w-full rounded-xl border border-slate-300 bg-white px-3 pb-2 pt-5 text-[12px] text-slate-900 shadow-sm outline-none transition focus:border-[#ede8fe] focus:ring-1 focus:ring-[#ede8fe]"
      />
      <label
        htmlFor={id}
  ...
  return (
    <div className="relative">
      <select
        ...
        value={value}
        onChange={(event) => onChange(event.target.value)}
        className="h-11 w-full appearance-none rounded-xl border border-slate-300 bg-white px-3 pb-1 pt-4 text-[12px] text-slate-900 shadow-sm outline-none transition focus:border-[#ede8fe] focus:ring-1 focus:ring-[#ede8fe]"
      >
        {children}
      </select>
      <label
