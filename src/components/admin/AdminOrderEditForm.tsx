  ...
  return (
    <div className="group relative" data-filled={isFilled(value) ? 'true' : 'false'}>
      <input
        ...
        className="h-11 w-full rounded-xl border border-slate-300 bg-white px-3 pb-1 pt-4 text-[12px] text-slate-900 shadow-sm outline-none transition focus:border-[#6244d8] focus:ring-1 focus:ring-[#6244d8]"
      />
      <label
        htmlFor={id}
  ...
  return (
    <div className="relative">
      <select
        ...
        value={value}
        onChange={(event) => onChange(event.target.value)}
        className="h-11 w-full appearance-none rounded-xl border border-slate-300 bg-white px-3 pb-1 pt-4 text-[12px] text-slate-900 shadow-sm outline-none transition focus:border-[#6244d8] focus:ring-1 focus:ring-[#6244d8]"
      >
        {children}
      </select>
      <label
