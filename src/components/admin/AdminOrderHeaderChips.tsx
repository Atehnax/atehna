  ...
  return (
    <div className="group relative" data-filled={filled ? 'true' : 'false'}>
      <input
        ...
        className="h-12 w-full overflow-visible rounded-xl border border-slate-300 bg-white px-2.5 pb-1.5 pt-5 text-xs leading-6 text-slate-900 outline-none transition focus:border-brand-500 focus:ring-1 focus:ring-brand-300"
      />
  ...
  return (
    <div className="group relative" data-filled={filled ? 'true' : 'false'}>
      <textarea
        ...
        placeholder=" "
        onChange={(event) => onChange(event.target.value)}
        className="min-h-[48px] w-full overflow-hidden rounded-xl border border-slate-300 bg-white px-2.5 pb-1.5 pt-5 text-xs leading-6 text-slate-900 outline-none transition focus:border-brand-500 focus:ring-1 focus:ring-brand-300"
      />
      <label className="pointer-events-none absolute left-2.5 top-1/2 -translate-y-1/2 bg-white px-0 text-xs text-slate-400 transition-all duration-150 group-focus-within:top-1.5 group-focus-within:translate-y-0 group-focus-within:px-1 group-focus-within:text-[10px] group-focus-within:text-slate-600 group-data-[filled=true]:top-1.5 group-data-[filled=true]:translate-y-0 group-data-[filled=true]:px-1 group-data-[filled=true]:text-[10px] group-data-[filled=true]:text-slate-600">
        {label}
      </label>
  ...
  return (
    <div className="relative">
      ...
      <select
        value={value}
        onChange={(event) => onChange(event.target.value)}
        className="h-12 w-full appearance-none overflow-visible rounded-xl border border-slate-300 bg-white px-2.5 pb-1.5 pt-5 text-xs leading-6 text-slate-900 outline-none transition focus:border-brand-500 focus:ring-1 focus:ring-brand-300"
      >
