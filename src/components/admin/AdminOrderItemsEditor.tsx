                    ...
                    <td className="px-2 py-2 align-middle text-center">
                      {itemsEditable ? (
                        <input
                          ...
                          className="h-6 w-12 rounded-md border border-slate-300 bg-white px-1 text-center text-[11px] leading-4 outline-none transition focus:border-brand-500 focus:ring-1 focus:ring-[#ede8fe]"
                        />
                      ) : (
                    ...
                    <td className="px-2 py-2 align-middle text-center">
                      {itemsEditable ? (
                        <input
                          ...
                          className="h-6 w-[4.5rem] rounded-md border border-slate-300 bg-white px-1 text-center text-[11px] leading-4 outline-none transition focus:border-brand-500 focus:ring-1 focus:ring-[#ede8fe]"
                        />
                      ) : (
                    ...
                    <td className="px-2 py-2 align-middle text-center">
                      {itemsEditable ? (
                        <input
                          ...
                          className="h-6 w-14 rounded-md border border-slate-300 bg-white px-1 text-center text-[11px] leading-4 outline-none transition focus:border-brand-500 focus:ring-1 focus:ring-[#ede8fe]"
                        />
                      ) : (
          ...
          <div className="flex items-center justify-between">
            ...
            {itemsEditable ? (
              <input
                ...
                className="h-6 w-full max-w-none rounded-md border border-slate-300 bg-white px-1 text-right text-[11px] leading-4 outline-none transition focus:border-brand-500 focus:ring-1 focus:ring-[#ede8fe] sm:max-w-[60px]"
              />
            ) : (
