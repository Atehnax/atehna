      ...
      <div className="mt-4 rounded-2xl border border-slate-200/80 p-3.5">
        ...
        {notesSectionMode === 'edit' ? (
          <textarea
            ...
            rows={2}
            className={`${notesBoxClass} w-full resize-none bg-white outline-none transition focus:border-[#ede8fe] focus:ring-1 focus:ring-[#ede8fe]`}
          />
        ) : (
                              ...
                              <div className="min-w-0 flex items-center gap-2">
                                ...
                                {hasMultipleVersions && isNewest ? (
                                  <button
                                    ...
                                    className="shrink-0 text-xs font-semibold text-slate-500 hover:text-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ede8fe]"
                                    aria-label={
                                      isExpanded
