...
export default function AdminOrdersPdfCell({
  ...
  const selectRefs = useRef<Partial<Record<PdfTypeKey, HTMLSelectElement | null>>>({});
        ...
        return (
          <div key={pdf.key} className="flex w-[190px] flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={() => selectRefs.current[pdf.key]?.focus()}
                className="rounded-full border border-slate-200 px-2 py-1 text-xs text-slate-500 hover:border-brand-200 hover:text-brand-600"
