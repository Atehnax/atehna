        ...
        <div className="mb-2 flex items-center justify-between gap-2 border-b border-slate-100 pb-2">
          ...
          {isGenerateKey(button.key) ? (
            <button
              ...
              className="inline-flex h-6 items-center rounded-md border border-slate-300 bg-white px-2 text-[10px] font-medium text-slate-700 transition hover:border-[#b9c8ff] hover:bg-[#eef3ff] disabled:cursor-default disabled:text-slate-300"
            >
        ...
        return (
          <div key={button.key} className="relative" data-no-row-nav>
            <button
              ...
              className="relative inline-flex h-6 items-center rounded-md border border-slate-200 bg-slate-50 px-1.5 py-1 text-[11px] font-medium text-slate-700 transition hover:border-[#b9c8ff] hover:bg-[#eef3ff] disabled:cursor-default disabled:text-slate-300"
            >
