...
export default function StatusChip({ status, isSaving = false }: Props) {
  return (
    <span
      className={`mx-auto inline-flex h-6 min-w-[104px] items-center justify-center rounded-full border px-2 text-[11px] font-semibold leading-none ${getStatusChipClassName(
        status
      )}`}
    >
