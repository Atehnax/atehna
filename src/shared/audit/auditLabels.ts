...
export const AUDIT_FIELD_LABELS: Record<string, string> = {
  ...
  media: 'Mediji',
  presentation: 'Videz',
  appearanceOverride: 'Videz artikla',
  ...
  email: 'Email',
  address_line1: 'Naslov',
  address_line2: 'Dodatni podatki naslova',
  postal_code: 'Poštna številka',
  city: 'Kraj',
  gurs_house_number_id: 'GURS ID naslova',
  country_code: 'Država',
  commitment_status: 'Zavezanost naročila',
  reference: 'Referenca',
