...
async function readLogoLibrary(): Promise<LogoLibrary> {
  ...
  if (Date.now() - lastInitializationFailureAt < 15_000) throw new LogoLibraryError('Knjižnice logotipov še ni mogoče pripraviti. Obstoječe nastavitve so ohranjene; poskusite znova čez nekaj trenutkov.', 503);
