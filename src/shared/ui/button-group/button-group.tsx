...
export function ButtonGroupItem({ children, isSelected = false, className, ...props }: ButtonGroupItemProps) {
  return (
    <div
      ...
      className={classNames(
        'relative z-0 flex items-stretch [&_button]:!rounded-none [&_a]:!rounded-none focus-within:z-10 focus-within:ring-1 focus-within:ring-[#3e67d6] focus-within:ring-inset data-[selected=true]:z-10 data-[selected=true]:ring-1 data-[selected=true]:ring-[#3e67d6] data-[selected=true]:ring-inset',
        className
      )}
    >
      {children}
