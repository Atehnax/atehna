...
const toneClasses = {
  order: {
    ...
    fieldset: 'rounded-lg',
    legend:
      'mx-2 max-w-0 overflow-hidden whitespace-nowrap px-1 text-[11px] leading-none text-slate-600 transition-[max-width] duration-150',
    inputLabel:
  ...
  admin: {
    ...
    fieldset: 'rounded-xl',
    legend:
      'mx-2 max-w-0 overflow-hidden whitespace-nowrap px-1 text-[10px] leading-none text-slate-600 transition-[max-width] duration-150',
    inputLabel:
