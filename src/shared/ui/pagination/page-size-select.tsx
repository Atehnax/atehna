  ...
  return (
    <div className={className}>
      ...
      <CustomSelect
        ...
        className="!pb-0 !pt-0 flex h-8 w-[216px] items-center justify-center rounded-md border border-slate-300 bg-white px-6 text-xs font-semibold leading-none text-slate-700 shadow-none"
