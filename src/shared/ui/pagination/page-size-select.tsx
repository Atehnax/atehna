  ...
  return (
    <div className={className}>
      ...
      <CustomSelect
        ...
        className="!pb-0 !pt-0 flex h-8 w-[42px] items-center justify-center rounded-md border border-slate-300 bg-transparent px-2 text-xs font-semibold leading-none text-slate-700 shadow-none"
