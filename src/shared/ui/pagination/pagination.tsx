    ...
    >
      ...
      <div className="inline-flex items-center gap-0.5">
        <IconButton
          ...
          disabled={safePage <= 1}
          className={classNames('border-0 text-slate-600 hover:border-slate-300 hover:bg-slate-100 disabled:text-slate-400 disabled:opacity-70', sizeClassMap[size].icon)}
