...
export const iconButtonTokenClasses = {
  ...
  neutralStatus:
    'border border-slate-300 bg-[color:var(--ui-neutral-bg)] text-slate-700 shadow-none transition hover:border-slate-300 hover:bg-[color:var(--ui-neutral-bg-hover)] active:bg-[color:var(--ui-neutral-bg-hover)] disabled:cursor-default disabled:pointer-events-none disabled:opacity-60 disabled:bg-transparent disabled:text-slate-400',
  success:
