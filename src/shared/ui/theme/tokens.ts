...
const BTN_BASE =
  "inline-flex items-center justify-center font-['Inter'] font-medium tracking-[-0.005em] transition disabled:pointer-events-none disabled:opacity-45";
const BTN_FOCUS =
...
const BTN_SIZE_PILL = 'h-9 px-4 rounded-lg text-[13px] leading-none';
