...
export const selectTokenClasses = {
  ...
  menuItem:
    `flex h-7 w-full items-center rounded-md px-2 text-left text-[11px] font-semibold leading-none text-slate-700 transition ${hoverTokenClasses.neutral} disabled:cursor-default disabled:text-slate-300`
} as const;
