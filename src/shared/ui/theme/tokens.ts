...
const BTN_BASE =
  "inline-flex items-center justify-center font-['Inter'] font-normal transition disabled:pointer-events-none disabled:opacity-45";
const BTN_FOCUS =
...
const BTN_SIZE_PILL = 'h-8 px-3 rounded-md text-sm';
